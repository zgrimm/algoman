...
%
\noindent\fbox{\parbox{\textwidth}{%
\emph{Take-Home Lesson: } An important and honorable tecnique in algorithm design is to narrow the set of allowable instances until there \emph{is} a correct and efficient algorithm. For example, we can restrict a graph problem from general graphs down to trees, or a geometric problem from two dimensions down to one.
}%
}
