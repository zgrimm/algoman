...
\begin{soleqo}
  ...
  &= \sum_{i=1}^{n}\sum_{j=1}^{i}\bigg(i(i+j)-\Big(\frac{(i+j)(i+j+1)}{2} -\frac{j(j+1)}{2}\Big)\bigg)\\
  &= \sum_{i=1}^{n}\sum_{j=1}^{i}\bigg(i(i+j)-\Big(\frac{i^{2}+2ij+i+j^{2}+j - j^{2} - j}{2}\Big)\bigg)\\
  &= \sum_{i=1}^{n}\sum_{j=1}^{i}\bigg(i(i+j)-\Big(\frac{i^{2}+2ij+i}{2}\Big)\bigg)\\
  &= \frac{1}{2}\sum_{i=1}^{n}\sum_{j=1}^{i}\bigg(2i^{2}+2ij-i^{2}-2ij-i\bigg)\\
  &= \frac{1}{2}\sum_{i=1}^{n}\sum_{j=1}^{i}\bigg(i^{2}-i\bigg)\\
  &= \frac{1}{2}\sum_{i=1}^{n}\bigg(i^{3}-i^{2}\bigg)\\
  &= \frac{1}{2}\bigg(\frac{n^{2}(n+1)^{2}}{4}-\frac{n(n+1)(2n+1)}{6}\bigg)\\
  &= \frac{1}{12}\bigg(3n^{2}(n+1)^{2} -2n(n+1)(2n+1)\bigg)\\
  &= \frac{1}{12}\bigg(\Big(n(n+1)\Big)\Big(3n(n+1) - 2(2n+1)\Big)\bigg)\\
  &= \frac{1}{12}\bigg(\Big(n(n+1)\Big)\Big(3n^{2}+3n-4n-1\Big)\bigg)\\
  &= \frac{1}{12}\bigg(\Big(n(n+1)\Big)\Big(3n^{2}-4n-1\Big)\bigg)\\
  &= \frac{1}{12}\bigg(\Big(n^{2}+n\Big)\Big(3n^{2}-4n-1\Big)\bigg)\\
  &= \frac{1}{12}\bigg(3n^{4}-4n^{3}-n^{2}+3n^{3}-4n^{2}-n\bigg)\\
  &= \frac{1}{12}\bigg(3n^{4}-n^{3}-5n^{2}-n\bigg)\\
