...
\text{\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\; 
\emph{between a and b is not the shortest route}} \\
%
{\color{answer}{}
\begin{center}
	\begin{tikzcd}
...
\end{center}}
%
\paragraph{\qquad {\color{answer}{}Although the distance from A to B through C is shorter than goingthrough D, \;\;\;\;\;\;\; road constraints limit the time it takes making the route through D faster despite it }}
%
\textbf{Ex:1-4.} \emph{Design/draw a road network with two points a and b such that the shortest } \newline{}
\text{\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\; 
\emph{route between a and b is not the route with the fewest turns}} \\
%
{\color{answer}{}
\begin{center}
	\begin{tikzcd}
