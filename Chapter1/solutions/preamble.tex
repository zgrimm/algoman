...
\usepackage{amsmath,bm,environ}

% so we can use relaive path,s when including stuff
% \usepackage{import}
\floatstyle{ruled}
...
%for changing fon etc of tittles of sections, subsections...
\usepackage{titlesec}

\titleformat*{\subsubsection}{\normalfont\fontsize{12}{17}\selectfont}
...
% for solutions
\definecolor{answer}{rgb}{0,0.26,0.15}
...
\NewEnviron{solgr}[1]{{\color{answer}{}\begin{center}\begin{tikzcd}\BODY\end{tikzcd}\end{center}}}{#1}
